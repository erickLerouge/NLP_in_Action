...
### hyperparameters
maxlen = 400
# the number of sambples to show the net before backpropagating the eror and updating the weights
batch_size = 32
# lenght of token vectors we will create for passing into the convnet
embedding_dims = 300
epochs = 2
